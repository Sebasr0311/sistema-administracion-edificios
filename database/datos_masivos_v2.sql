-- =============================================================================
-- SAED — Datos masivos v2 (corregido)
-- 16 aptos (pisos 2-5, 4 x piso) | 38 parqueaderos | 17 residentes
-- =============================================================================
...
-- Reseteamos secuencias al valor mínimo tras el DELETE
BEGIN
...
VALUES (SEC_APARTAMENTOS.NEXTVAL,'201',2,'1_HAB',50,2,'OCUPADO',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'202',2,'2_HAB',70,3,'OCUPADO',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'203',2,'ESTUDIO',40,2,'DISPONIBLE',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'204',2,'1_HAB',50,2,'DISPONIBLE',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'301',3,'2_HAB',75,4,'OCUPADO',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'302',3,'3_HAB',95,5,'OCUPADO',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'303',3,'1_HAB',55,2,'DISPONIBLE',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'304',3,'2_HAB',70,3,'DISPONIBLE',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'401',4,'3_HAB',90,5,'OCUPADO',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'402',4,'PENTHOUSE',140,6,'OCUPADO',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'403',4,'2_HAB',75,4,'DISPONIBLE',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'404',4,'3_HAB',85,4,'DISPONIBLE',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'501',5,'1_HAB',55,2,'OCUPADO',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'502',5,'1_HAB',60,3,'OCUPADO',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'503',5,'ESTUDIO',42,2,'DISPONIBLE',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO APARTAMENTOS (id_apartamento,numero,piso,tipo,area_m2,capacidad_maxima,estado,activo,fecha_registro,actualizado_en)
VALUES (SEC_APARTAMENTOS.NEXTVAL,'504',5,'ESTUDIO',38,2,'DISPONIBLE',1,SYSTIMESTAMP,SYSTIMESTAMP);
COMMIT;

-- ============================== PARQUEADEROS ================================
-- 16 fijos P01-P16 (uno x apto ordenado por numero)
DECLARE
  CURSOR c_aptos IS SELECT id_apartamento FROM APARTAMENTOS ORDER BY numero;
  v_cont NUMBER := 0;
BEGIN
  FOR a IN c_aptos LOOP
    v_cont := v_cont + 1;
    INSERT INTO PARQUEADEROS (id_parqueadero,codigo,tipo,es_visitante,estado,id_apartamento,fecha_registro,actualizado_en)
    VALUES (SEC_PARQUEADEROS.NEXTVAL, 'P'||LPAD(v_cont,2,'0'), 'VEHICULO', 0, 'DISPONIBLE', a.id_apartamento, SYSTIMESTAMP, SYSTIMESTAMP);
  END LOOP;
  COMMIT;
END;
/
...
BEGIN
  FOR i IN 1..10 LOOP
    INSERT INTO PARQUEADEROS (id_parqueadero,codigo,tipo,es_visitante,estado,fecha_registro,actualizado_en)
    VALUES (SEC_PARQUEADEROS.NEXTVAL, 'V'||LPAD(i,2,'0'), 'VEHICULO', 1, 'DISPONIBLE', SYSTIMESTAMP, SYSTIMESTAMP);
  END LOOP;
  COMMIT;
END;
/
...
BEGIN
  FOR i IN 1..12 LOOP
    INSERT INTO PARQUEADEROS (id_parqueadero,codigo,tipo,es_visitante,estado,fecha_registro,actualizado_en)
    VALUES (SEC_PARQUEADEROS.NEXTVAL, 'M'||LPAD(i,2,'0'), 'MOTO', 1, 'DISPONIBLE', SYSTIMESTAMP, SYSTIMESTAMP);
  END LOOP;
  COMMIT;
END;
/
...
-- ============================== RESIDENTES ==================================
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000001','Carlos Andrés','Pérez Ramos',   DATE '1990-03-15','3001110001','carlos.perez@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000002','María Fernanda','Ruiz Torres',  DATE '1993-07-22','3001110002','maria.ruiz@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000003','Jhon Sebastián','Martínez López',DATE '1985-11-08','3001110003','jhon.martinez@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000004','Luisa Valentina','Gómez Ríos',   DATE '1991-05-30','3001110004','luisa.gomez@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000005','Pedro Antonio','Soto Vargas',    DATE '1978-02-14','3001110005','pedro.soto@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,5,'50000001','Miguel Ángel','Torres Soto',    DATE '2010-06-12',NULL,NULL,1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000006','Andrés Felipe','Ramírez Ortiz',  DATE '1988-09-20','3001110006','andres.ramirez@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000007','Carolina','Morales Peña',       DATE '1992-12-10','3001110007','carolina.morales@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000008','Daniel','Castro Medina',        DATE '1980-04-05','3001110008','daniel.castro@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000009','Laura','Londoño Vélez',         DATE '1985-08-15','3001110009','laura.londono@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000010','Fernando','Vargas Uribe',       DATE '1975-11-30','3001110010','fernando.vargas@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000011','Ana Lucía','Ríos Mejía',        DATE '1978-03-22','3001110011','ana.rios@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000012','Gabriel','Torres Pabón',        DATE '1995-06-18','3001110012','gabriel.torres@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000013','Valentina','Herrera Díaz',      DATE '1997-01-25','3001110013','valentina.herrera@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000014','Héctor','Mendoza Salazar',      DATE '1982-09-08','3001110014','hector.mendoza@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000015','Diana','Rojas Pineda',          DATE '1986-04-14','3001110015','diana.rojas@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,1,'10000016','Ana','Morales Peña',            DATE '1970-09-25','3001110016','ana.morales2@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO RESIDENTES (id_residente,id_tipo_doc,numero_documento,nombres,apellidos,fecha_nacimiento,telefono,email,activo,fecha_registro,actualizado_en)
VALUES (SEC_RESIDENTES.NEXTVAL,2,'CE100001','Jean','Pierre Dubois',          DATE '1985-07-14','3001110017','jean.dubois@email.com',1,SYSTIMESTAMP,SYSTIMESTAMP);
COMMIT;

-- ============================== USUARIOS ====================================
INSERT INTO USUARIOS (id_usuario,id_residente,username,password_hash,rol,activo,fecha_registro,actualizado_en)
VALUES (SEC_USUARIOS.NEXTVAL,NULL,'admin','$2b$12$eImiTXuWVxfM37uY4JANjOeH/y3bFMPqV5oRqF2LYqHBH0X3hZBfO','ADMINISTRADOR',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO USUARIOS (id_usuario,id_residente,username,password_hash,rol,activo,fecha_registro,actualizado_en)
VALUES (SEC_USUARIOS.NEXTVAL,NULL,'portero1','$2b$12$eImiTXuWVxfM37uY4JANjOeH/y3bFMPqV5oRqF2LYqHBH0X3hZBfO','PORTERO',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO USUARIOS (id_usuario,id_residente,username,password_hash,rol,activo,fecha_registro,actualizado_en)
VALUES (SEC_USUARIOS.NEXTVAL,NULL,'portero2','$2b$12$eImiTXuWVxfM37uY4JANjOeH/y3bFMPqV5oRqF2LYqHBH0X3hZBfO','PORTERO',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO USUARIOS (id_usuario,id_residente,username,password_hash,rol,activo,fecha_registro,actualizado_en)
VALUES (SEC_USUARIOS.NEXTVAL,(SELECT id_residente FROM RESIDENTES WHERE numero_documento='10000001'),'carlos','$2b$12$eImiTXuWVxfM37uY4JANjOeH/y3bFMPqV5oRqF2LYqHBH0X3hZBfO','RESIDENTE',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO USUARIOS (id_usuario,id_residente,username,password_hash,rol,activo,fecha_registro,actualizado_en)
VALUES (SEC_USUARIOS.NEXTVAL,(SELECT id_residente FROM RESIDENTES WHERE numero_documento='10000003'),'jhon','$2b$12$eImiTXuWVxfM37uY4JANjOeH/y3bFMPqV5oRqF2LYqHBH0X3hZBfO','RESIDENTE',1,SYSTIMESTAMP,SYSTIMESTAMP);
COMMIT;

-- ============================== CONTRATOS ===================================
-- 8 contratos ACTIVO para los 8 aptos OCUPADOS, con valores fijos por apto
...
SELECT SEC_CONTRATOS.NEXTVAL, a.id_apartamento, u.id_usuario, DATE '2024-01-01',
       CASE a.numero
...
WHERE a.estado='OCUPADO' AND u.username='admin'
ORDER BY a.numero;
COMMIT;

-- ============================== CONTRATO_RESIDENTE + TUTORES ================
DECLARE
  v_contrato_id CONTRATOS.id_contrato%TYPE;
  v_arrendatario RESIDENTES.id_residente%TYPE;
  v_conviviente RESIDENTES.id_residente%TYPE;
BEGIN
  -- AP-201: Carlos (ARRENDATARIO), María (OTRO)
  SELECT id_contrato INTO v_contrato_id FROM CONTRATOS c JOIN APARTAMENTOS a ON c.id_apartamento=a.id_apartamento WHERE a.numero='201' AND c.estado='ACTIVO';
  SELECT id_residente INTO v_arrendatario FROM RESIDENTES WHERE numero_documento='10000001';
  SELECT id_residente INTO v_conviviente FROM RESIDENTES WHERE numero_documento='10000002';
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_arrendatario, 'ARRENDATARIO');
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_conviviente, 'OTRO');

  -- AP-202: Jhon (ARRENDATARIO), Luisa (OTRO)
  SELECT id_contrato INTO v_contrato_id FROM CONTRATOS c JOIN APARTAMENTOS a ON c.id_apartamento=a.id_apartamento WHERE a.numero='202' AND c.estado='ACTIVO';
  SELECT id_residente INTO v_arrendatario FROM RESIDENTES WHERE numero_documento='10000003';
  SELECT id_residente INTO v_conviviente FROM RESIDENTES WHERE numero_documento='10000004';
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_arrendatario, 'ARRENDATARIO');
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_conviviente, 'OTRO');

  -- AP-301: Pedro (ARRENDATARIO), Miguel (RESIDENTE_MENOR)
  SELECT id_contrato INTO v_contrato_id FROM CONTRATOS c JOIN APARTAMENTOS a ON c.id_apartamento=a.id_apartamento WHERE a.numero='301' AND c.estado='ACTIVO';
  SELECT id_residente INTO v_arrendatario FROM RESIDENTES WHERE numero_documento='10000005';
  SELECT id_residente INTO v_conviviente FROM RESIDENTES WHERE numero_documento='50000001';
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_arrendatario, 'ARRENDATARIO');
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_conviviente, 'RESIDENTE_MENOR');
  INSERT INTO TUTORES (id_tutor,id_residente_menor,id_tipo_doc,numero_documento,nombres,apellidos,parentesco) VALUES (SEC_TUTORES.NEXTVAL, v_conviviente, 1, '10000005', 'Pedro Antonio', 'Soto Vargas', 'PADRE');

  -- AP-302: Andrés (ARRENDATARIO), Carolina (OTRO)
  SELECT id_contrato INTO v_contrato_id FROM CONTRATOS c JOIN APARTAMENTOS a ON c.id_apartamento=a.id_apartamento WHERE a.numero='302' AND c.estado='ACTIVO';
  SELECT id_residente INTO v_arrendatario FROM RESIDENTES WHERE numero_documento='10000006';
  SELECT id_residente INTO v_conviviente FROM RESIDENTES WHERE numero_documento='10000007';
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_arrendatario, 'ARRENDATARIO');
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_conviviente, 'OTRO');

  -- AP-401: Daniel (ARRENDATARIO), Laura (OTRO)
  SELECT id_contrato INTO v_contrato_id FROM CONTRATOS c JOIN APARTAMENTOS a ON c.id_apartamento=a.id_apartamento WHERE a.numero='401' AND c.estado='ACTIVO';
  SELECT id_residente INTO v_arrendatario FROM RESIDENTES WHERE numero_documento='10000008';
  SELECT id_residente INTO v_conviviente FROM RESIDENTES WHERE numero_documento='10000009';
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_arrendatario, 'ARRENDATARIO');
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_conviviente, 'OTRO');

  -- AP-402: Fernando (ARRENDATARIO), Ana Lucía (OTRO)
  SELECT id_contrato INTO v_contrato_id FROM CONTRATOS c JOIN APARTAMENTOS a ON c.id_apartamento=a.id_apartamento WHERE a.numero='402' AND c.estado='ACTIVO';
  SELECT id_residente INTO v_arrendatario FROM RESIDENTES WHERE numero_documento='10000010';
  SELECT id_residente INTO v_conviviente FROM RESIDENTES WHERE numero_documento='10000011';
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_arrendatario, 'ARRENDATARIO');
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_conviviente, 'OTRO');

  -- AP-501: Gabriel (ARRENDATARIO), Valentina (OTRO)
  SELECT id_contrato INTO v_contrato_id FROM CONTRATOS c JOIN APARTAMENTOS a ON c.id_apartamento=a.id_apartamento WHERE a.numero='501' AND c.estado='ACTIVO';
  SELECT id_residente INTO v_arrendatario FROM RESIDENTES WHERE numero_documento='10000012';
  SELECT id_residente INTO v_conviviente FROM RESIDENTES WHERE numero_documento='10000013';
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_arrendatario, 'ARRENDATARIO');
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_conviviente, 'OTRO');

  -- AP-502: Héctor (ARRENDATARIO), Diana (OTRO)
  SELECT id_contrato INTO v_contrato_id FROM CONTRATOS c JOIN APARTAMENTOS a ON c.id_apartamento=a.id_apartamento WHERE a.numero='502' AND c.estado='ACTIVO';
  SELECT id_residente INTO v_arrendatario FROM RESIDENTES WHERE numero_documento='10000014';
  SELECT id_residente INTO v_conviviente FROM RESIDENTES WHERE numero_documento='10000015';
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_arrendatario, 'ARRENDATARIO');
  INSERT INTO CONTRATO_RESIDENTE VALUES (SEC_CONTRATO_RESIDENTE.NEXTVAL, v_contrato_id, v_conviviente, 'OTRO');
...
VALUES (SEC_VISITANTES.NEXTVAL,1,'20000001','Laura Camila','Díaz Suárez','3111000001',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO VISITANTES (id_visitante,id_tipo_doc,numero_documento,nombres,apellidos,telefono,activo,fecha_registro,actualizado_en)
VALUES (SEC_VISITANTES.NEXTVAL,1,'20000002','Roberto','Castillo Medina','3111000002',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO VISITANTES (id_visitante,id_tipo_doc,numero_documento,nombres,apellidos,telefono,activo,fecha_registro,actualizado_en)
VALUES (SEC_VISITANTES.NEXTVAL,1,'20000003','Fernando','Ospina Lara','3111000003',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO VISITANTES (id_visitante,id_tipo_doc,numero_documento,nombres,apellidos,telefono,activo,fecha_registro,actualizado_en)
VALUES (SEC_VISITANTES.NEXTVAL,4,'PAS00001','Emily','Johnson',NULL,1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO VISITANTES (id_visitante,id_tipo_doc,numero_documento,nombres,apellidos,telefono,activo,fecha_registro,actualizado_en)
VALUES (SEC_VISITANTES.NEXTVAL,2,'CE200001','Jean Pierre','Dupont','3111000004',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO VISITANTES (id_visitante,id_tipo_doc,numero_documento,nombres,apellidos,telefono,activo,fecha_registro,actualizado_en)
VALUES (SEC_VISITANTES.NEXTVAL,1,'20000004','Marcela','Giraldo Pérez','3111000005',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO VISITANTES (id_visitante,id_tipo_doc,numero_documento,nombres,apellidos,telefono,activo,fecha_registro,actualizado_en)
VALUES (SEC_VISITANTES.NEXTVAL,1,'20000005','Sergio','Londoño Arias','3111000006',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO VISITANTES (id_visitante,id_tipo_doc,numero_documento,nombres,apellidos,telefono,activo,fecha_registro,actualizado_en)
VALUES (SEC_VISITANTES.NEXTVAL,1,'20000006','Paola','Montoya Gil','3111000007',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO VISITANTES (id_visitante,id_tipo_doc,numero_documento,nombres,apellidos,telefono,activo,fecha_registro,actualizado_en)
VALUES (SEC_VISITANTES.NEXTVAL,1,'20000007','Camilo','Restrepo Zuluaga','3111000008',1,SYSTIMESTAMP,SYSTIMESTAMP);
INSERT INTO VISITANTES (id_visitante,id_tipo_doc,numero_documento,nombres,apellidos,telefono,activo,fecha_registro,actualizado_en)
VALUES (SEC_VISITANTES.NEXTVAL,1,'20000008','Andrea','Cifuentes Duque','3111000009',1,SYSTIMESTAMP,SYSTIMESTAMP);
COMMIT;

-- ============================== VISITAS =====================================
-- El trigger TRG_VIS_VALIDAR_RESIDENTE exige que id_residente en VISITAS
-- coincida con la CONTRATO_RESIDENTE del id_contrato_res usado.
...
-- Visitas finalizadas para los otros arrendatarios
INSERT INTO VISITAS (id_visita,id_contrato_res,id_residente,tiempo_validez_min,cantidad_personas,estado,notas,fecha_registro,actualizado_en)
...
-- Visitas sociales finalizadas: asignar visitantes
INSERT INTO REGISTRO_VISITA (id_registro_visita,id_visita,id_visitante,es_titular)
SELECT SEC_REGISTRO_VISITA.NEXTVAL, v.id_visita, vis.id_visitante, 1
...
-- QR para visita FINALIZADA (frecuente)
INSERT INTO QR_ACCESOS (id_qr,id_visita,codigo_qr,fecha_generacion,fecha_expiracion,usado,fecha_uso,id_vigilante_uso)
SELECT SEC_QR_ACCESOS.NEXTVAL, v.id_visita, 'QR-'||RAWTOHEX(SYS_GUID()),
...
-- Visita FINALIZADA: entró y salió
...
SELECT SEC_BUZON.NEXTVAL, a.id_apartamento, 'AVISO', 'Corte de agua programado',
       '30 de mayo 8am-2pm mantenimiento.',
       u.id_usuario, 0
FROM APARTAMENTOS a
CROSS JOIN (SELECT id_usuario FROM USUARIOS WHERE username='admin') u
...
SELECT SEC_BUZON.NEXTVAL, a.id_apartamento, 'PAQUETE', 'Paquete Amazon',
       'Paquete Amazon 2.5kg recibido.', u.id_usuario,
...
FROM APARTAMENTOS a
JOIN BUZON b ON b.id_apartamento=a.id_apartamento AND b.tipo='PAQUETE'
CROSS JOIN (SELECT id_usuario FROM USUARIOS WHERE username='portero1') u
WHERE a.numero='201';
COMMIT;
